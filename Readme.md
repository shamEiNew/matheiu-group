...
|---|---|---|---|
| 1 | $(g_1,g_2,g_3)$ multiply to 1, have cycle types $2^8 1^7$ (two transpositions, 1 fixed), $23$ (full cycle), $23$, generate a group of order 10, 200, 960 | ✅ done | Python/sympy — [code/python/check_triple.py](code/python/check_triple.py) |
...
### Claim 12 is a open-tooling gap
...
code/python/    pure-Python checks (no CAS needed)
